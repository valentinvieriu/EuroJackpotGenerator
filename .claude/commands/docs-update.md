...
2. **Identify Drift Points**: Look for:
   ...
   - **Role Boundary Violations**: Technical details in README.md, product specs in ARCHITECTURE.md
...
4. **Implementation**: Execute the synchronisation plan, ensuring:
   ...
   - **Content Boundary Enforcement**: No technical implementation in PRD.md, no product specs in ARCHITECTURE.md
...
6. **Content Overlap Prevention**:
   ...
   - PRD.md should focus on WHAT/WHY, ARCHITECTURE.md on HOW (conceptually)
...
9. **Strategic Cross-Referencing**:
   ...
   - PRD.md → ARCHITECTURE.md for implementation approaches
   - COMMON_GUIDE.md → specific docs for deep dives
   - ARCHITECTURE.md → PRD.md for business context only when necessary
